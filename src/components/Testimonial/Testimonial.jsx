...
const TestimonialsData =[
    {
        name:"Dilshad",
        image:"",
        description:"Lorem ipsum dolor dit amet consectetur, adipisicing elit,",
        aosDelay:"0",
    },
    {
        name:"Satya",
...
const Testimonial = () => {
  return (
      ...
      <div className='dark:bg-black dark:text-white py-14 dm:pb-24'>
        <div className='container'>
            ...
            <div className='space-y-4  pb-12 '>
                ...
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut atque autem magnam iure similique!{" "}</p>
            </div>
            {/* card section */}
